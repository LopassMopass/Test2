  ...
  <body>
      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            <li class="nav-item"><a href="./animal.php" class="nav-link px-2 text-white">Animal List</a></li>
            <li class="nav-item"><a href="./behavier.php" class="nav-link px-2 text-secondary">Animal Behavier</a></li>
          </ul>
        </div>
      </div> 
    </header>
    ...
    <div>
      <ul class="list-group list-group-horizontal">
        ...
        <li class="list-group-item">Can be aggresive</li>
      </ul>
      
      <ul class="list-group list-group-horizontal-sm">
        <li class="list-group-item">Cat</li>
        <li class="list-group-item">Is less active when sun is up</li>
      </ul>
      
      <ul class="list-group list-group-horizontal-md">
        <li class="list-group-item">Bird</li>
        <li class="list-group-item">Screams a lot</li>
      </ul>
    </div>
